...
public class WeChatStoreUtils {
    ...
    public WxMpStoreBaseInfo get(String poiId) throws WxErrorException {
        WxMpStoreBaseInfo baseInfo = wxMpService.getStoreService().get(poiId);
        return baseInfo;
    }
    ...
    public void delete(String poiId) throws WxErrorException {
        wxMpService.getStoreService().delete(poiId);
    }

    /**
     * <pre>
     * @desc: 查询门店列表(指定查询起始位置和个数)
    ...
    public WxMpStoreListResult list(int begin, int limit) throws WxErrorException {
        WxMpStoreListResult wxMpStoreListResult = wxMpService.getStoreService().list(begin, limit);
        return wxMpStoreListResult;
    }
    ...
    public List<WxMpStoreInfo> listAll() throws WxErrorException {
        List<WxMpStoreInfo> listAll = wxMpService.getStoreService().listAll();
        return listAll;
    }
     ...
     * </pre>
     */
    public void update(WxMpStoreBaseInfo info) throws WxErrorException {
        wxMpService.getStoreService().update(info);
    }
    ...
    public List<String> listCategories() throws WxErrorException {
        List<String> listCategories = wxMpService.getStoreService().listCategories();
